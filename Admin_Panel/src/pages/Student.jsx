...
function Student() {
  ...
  //SEARCH LOGIC
  const filteredStudents = prioritySearch(studdata, search, [
    "stud_id",
    "user_id",
    "education",
    "skills",
      ...
      <div className="flex">
        ...
        <div className="ml-64 p-6 w-full min-h-screen bg-gray-900">
          ...
          <SearchBar
            ...
            placeholder="Search by education, skills, user ID..."
          />
          ...
          <div className="bg-gray-900 w-[600px] rounded-2xl shadow-2xl border border-gray-700 p-6 relative">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div className="bg-gray-800 p-3 rounded-lg col-span-2">
                ...
                <p className="text-white font-semibold">{selectedStudent.skills}</p>
              </div>

              <div className="bg-gray-800 p-3 rounded-lg col-span-2">
                <p className="text-gray-400">Languages</p>
                <p className="text-white font-semibold">{selectedStudent.language}</p>
              </div>
            </div>
